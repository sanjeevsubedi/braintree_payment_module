<?php  
    ...
    $subscription_amt = $is_practice ? SUBSCRIPTION_AMT : SUBSCRIPTION_AMT_PATIENT;
            ...
            paymentUtilities = {
                ...
                processPayPal: function() {
                    ...
                    var postdata =  "&"+ billingInfo + "&nonce=" + paypalNonce+ "&data="+JSON.stringify(data);
                     ...
                     paymentAjaxBase('add',postdata, $("#braintree-payment-form").closest('.step').find(".spinner-vat"),function(resp,error){
                        ...
                        paymentAjaxBase('verify_sms_token',postdata,$("#"+formId).closest('.step').find(".spinner-vat"),function(resp,error){
                            ...
                            //if(resp) {
                                ...
                                if (!resp) {
                                    ...
                                    paymentUtilities.menuHandler(1,"#step-2");
        ...
        $(".blue-btn,.payment-navigation li a").on('click', function() {
            ...
            if($(this).attr('id') == 'gotodash') {
                ...
                if(!chk) {
                    ...
                    //take the user to next step
                     paymentUtilities.menuHandler(1,"#step-1-2");
                }
    ...
    <section class="white-bg payment-wrap text-center">
        ...
        <div class="payment-navigation">
            <ul>
                ...
                <li id="billing"><a href="#" class="active"><?php echo lang("payment.billiing_address"); ?></a></li>
        ...
        <div class="container-fluid payment-cnt-bg">
                ...
                <form action="" id="payment-info">
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <div class="white-bg payment-white-bg">
                            ...
                            <p><?php //echo lang("payment.need_to_subscribe_for_3_month_to_use_physio_to_go"); ?></p>
                        </div>
            ...
            <!-- Billing Address -->
            <div class="billing-address billing step" id="step-0">
            ...
            <!-- User Type -->
            <div class="payment-vat user-type vat step" id="step-1">
                ...
                <!-- Mobile verification -->  
                    <div class="payment-vat-non-eu step" id="step-1-1">
                    ...
                    <div class="payment-vat-non-eu step" id="step-1-2">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2 sales-tax-form-cnt aline-center">
                                    ...
                                    <fieldset class="form-radio">
                                        ...
                                        <label for=""><span><?php echo lang("payment.certify_company_headquarter"); ?><strong id="agreebillingaddress"></strong> <!--<strong> ist.</strong>--></label>
                                    </fieldset>
                                </div>
                            </div>
            ...
            <!-- Vat Rate -->
            <div class="payment-confirmation vat-rate step" id="step-2">
                <form action="" id="vat_details">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <p><?php //echo lang("payment.vat_requirement_description"); ?></p>
            ...
            <!-- Vat Rate -->  
                   ...
                   <!-- Payment Summary -->
            <div class="payment-summary summary step" id="step-3">
            ...
            <!-- End Payment Summary -->
                 ...
                 <!-- Payment details -->
            <div class="payment-details payment step" id="step-4">
            ...
            <div class="pyment-confirmation confirm step" id="step-5">
                <div class="col-md-6 col-md-offset-3 white-bg payment-white-bg text-center">
                    <p>Vielen Dank für Ihre neue Daten.</p>
                    <p>Diese werden bei der nächsten Abbuchung berücksichtigt.</p>
                    ...
                    <p>Falls Sie noch Fragen zur Transaktion haben, schicken Sie bitte eine Email an <a href="#">payments@physiotogo.de</a>.</p>-->
                </div>
                <div class="col-md-12 text-center">
                        ...
                        billingAddress: {
                            ...
                            var data = {
                              ...
                              var postdata = $("#"+formId).serialize()+ "&"+billingInfo+"&tot=" + total+"&data="+JSON.stringify(data);
                                ...
                                paymentAjaxBase('add',postdata, $("#"+formId + " .spinner-vat"),function(resp,error){
